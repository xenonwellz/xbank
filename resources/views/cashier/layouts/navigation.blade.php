<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('cashier.logout') }}">
                            ...
                            <x-dropdown-link :href="route('cashier.logout')"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="text-base font-medium text-gray-800">{{ Auth::guard('cashier')->user()->name }}</div>
                <div class="text-sm font-medium text-gray-500">{{ Auth::guard('cashier')->user()->email }}</div>
            </div>
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('cashier.logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('cashier.logout')"
                        onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
