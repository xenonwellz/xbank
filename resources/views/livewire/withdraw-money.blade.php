<div class="w-1/3 p-4 mx-auto mt-16 bg-white rounded-lg" x-on:click.away="openWithdraw=false">
    ...
    <div class="flex justify-between py-4">
        ...
        @if ($verified)
            <button class="px-10 py-3 text-sm font-semibold text-white rounded-lg bg-sky-700"
                wire:click='submit'>Withdraw</button>
        @else
            <button class="px-10 py-3 text-sm font-semibold text-white rounded-lg bg-sky-700"
