<div class="flex p-3 bg-white rounded-lg">
    ...
    <div class="flex-grow px-3">
        <h2 class="font-semibold">Deposited Cash</h2>
        <h3 class="text-sm text-gray-700">Processed bank deposit for <span
                class="font-semibold">{{ $transaction->user->name }}'s</span> -
